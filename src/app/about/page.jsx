      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              I’m a Data Processing Specialist, Web Developer,
              and NLP Enthusiast with a passion for turning complex data into
              clear insights and elegant user experiences. With hands-on
              experience in building responsive web applications and developing
              intelligent NLP pipelines, I thrive at the intersection of
              technology, language, and design.
            </p>

            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
              “Code is not just logic—it’s a language to communicate solutions.”
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    Creating actively hands-on projects and develop web projects.{" "}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Internship with 6 months by working with SQL and C# techs. Developing Web and Desktop applications.
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2021
